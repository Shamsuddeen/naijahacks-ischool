...
<head>
    ...
    <title>Submit Course Assignment - <?php info('site_name'); ?></title>
                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Courses <small>Submit Assignment</small></h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_title">
                                    <h2>Submit Assignment <small>Manual Form</small></h2>
                                    ...
                                    <form id="form" method="POST" action="#" data-parsley-validate
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <input type="hidden" id="assignment" class="form-control col-md-7 col-xs-12" name="assignment" value="<?php echo $assignment; ?>" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="files">
                                        ...
                                        <div class="ln_solid"></div>
                                        <?php
                                            // $assignment = getSubmittedAssignment($assignment, $student_id);
                                            if(getSubmittedAssignment($assignment, $student_id) == 0){
                                        ...
                                        ?>
                                                <div class="alert alert-danger">
                                                    ...
                                                    <strong><i class="fa fa-info-circle" aria-hidden="true"></i></strong> You have already submitted your assignment!
                                                </div>
                                        <?php
                                            }
                                        ?>
