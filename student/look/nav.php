						...
						<div class="cart-info">
							...
							<div class="ci-item">
								...
								<div class="ci-item-info">
									<h5><a href="<?php echo $navcartr['url']; ?>"><?php echo substr($navcartr['name'], 0 , 20); ?></a></h5>
									<p><?php echo $value['quantity']; ?> x <?php echo $currency; ?> <?php echo number_format($navcartr['price'],2); ?></p>
									<div class="ci-edit">
							...
							<div class="ci-total">Subtotal: <?php echo $currency; ?> <?php echo number_format($total, 2); ?></div>
							<div class="cart-btn">
